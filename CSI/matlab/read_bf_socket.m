...
%
% (c) 2008-2011 Daniel Halperins <dhalperi@cs.washington.edu>
%
...
%% Process all entries in socket
    ...
    output = [string(timestamp) A B C];
    outputs = [outputs; output];
    writematrix(outputs, 'outputs.csv');
...
%     %csi_data.timestamp = time;
%     csi_data.antenna_A = A;
%     csi_data.antenna_B = B;
%     csi_data.antenna_C = C;
%     csi_data.label = 2;
%     
